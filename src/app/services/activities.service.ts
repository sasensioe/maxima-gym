...
export class ActivitiesService {
  ...
  activities: Activity[] = [
    ...
    {
      title: 'YOGA',
      img: 'assets/img/activities/yoga.jpg',
    ...
    {
      title: 'BODY PUMP',
      img: 'assets/img/activities/body-pump.jpg',
    ...
    {
      title: 'BODY COMBAT',
      img: 'assets/img/activities/body-combat.jpg',
    ...
    {
      title: 'SPINNING',
      img: 'assets/img/activities/spinning.jpg',
    ...
    {
      title: 'TRX',
      img: 'assets/img/activities/trx.jpg',
    ...
    {
      title: 'PILATES',
      img: 'assets/img/activities/pilates.jpg',
